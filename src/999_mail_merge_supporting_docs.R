...
gs4_create(
  name = "KOP Q3/Q4 Mail Merge Sheet",
...
ss_kbp <- gs4_create(
  ...
  sheets = list("Grading Guidelines" = data.frame(
    Key = c("Exceeds", "Meets", "Approaching", "Not Yet"),
    Value = c(" ", " ", " ", " ")
  ))
)
